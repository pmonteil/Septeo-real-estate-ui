...
const aliasGroups: TokenGroup[] = [
  ...
  aliasScale("danger", "Danger (red)", "red", [
    { key: "10", brandKey: "10" },
    { key: "50", brandKey: "50" },
    { key: "100", brandKey: "100" },
    { key: "200", brandKey: "200" },
...
const mappedGroups: TokenGroup[] = [
  {
    ...
    tokens: [
      ...
      { var: "--text-body-secondary", label: "body-secondary", ref: "→ neutral-700" },
      ...
      { var: "--text-danger", label: "danger", ref: "→ danger-default" },
      ...
      { var: "--text-dynamic", label: "dynamic", ref: "→ ai-default" },
      { var: "--text-action-ai", label: "action-ai", ref: "→ ai-default" },
    ],
  },
  {
    name: "Icon",
    tokens: [
      ...
      { var: "--icon-title", label: "title", ref: "→ neutral-700" },
      { var: "--icon-secondary", label: "secondary", ref: "→ neutral-600" },
      ...
      { var: "--icon-danger", label: "danger", ref: "→ danger-default" },
      ...
      { var: "--icon-dynamic", label: "dynamic", ref: "→ ai-default" },
      { var: "--icon-action-ai", label: "action-ai", ref: "→ ai-default" },
    ],
  },
  {
    name: "Surface",
    tokens: [
      ...
      { var: "--surface-default-bis", label: "default-bis", ref: "→ neutral-50" },
      { var: "--surface-field", label: "field", ref: "→ neutral-10" },
      { var: "--surface-field-negative", label: "field-negative", ref: "→ danger-10" },
      ...
      { var: "--surface-neutral-hover", label: "neutral-hover", ref: "→ neutral-50" },
      { var: "--surface-unselected", label: "unselected", ref: "→ neutral-60" },
      { var: "--surface-unselected-hover", label: "unselected-hover", ref: "→ neutral-100" },
      { var: "--surface-danger", label: "danger", ref: "→ danger-50" },
      { var: "--surface-danger-hover", label: "danger-hover", ref: "→ danger-100" },
  ...
  },
  {
    ...
    tokens: [
      ...
      { var: "--border-negative", label: "negative", ref: "→ danger-default" },
      { var: "--border-negative-light", label: "negative-light", ref: "→ danger-100" },
      { var: "--border-focus", label: "focus", ref: "→ primary-default" },
      { var: "--border-danger", label: "danger", ref: "→ danger-default" },
      ...
      { var: "--border-dynamic-dark", label: "dynamic-dark", ref: "→ ai-300" },
    ],
  },
];
</script>
